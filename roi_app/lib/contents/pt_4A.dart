...
class VideoPlayerScreen4A extends StatefulWidget {
  const VideoPlayerScreen4A({super.key});

  @override
  _VideoPlayerScreen4AState createState() => _VideoPlayerScreen4AState();
}

class _VideoPlayerScreen4AState extends State<VideoPlayerScreen4A> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this supplementary lesson, we focus on key Amendments to Fundamental Rights and significant judicial reviews.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'This session explores how Fundamental Rights have evolved through various Constitutional Amendments and landmark Supreme Court cases.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Judicial Review, Basic Structure', 
