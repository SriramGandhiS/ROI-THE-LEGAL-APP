...
class VideoPlayerScreen17 extends StatefulWidget {
  const VideoPlayerScreen17({super.key});

  @override
  _VideoPlayerScreen17State createState() => _VideoPlayerScreen17State();
}

class _VideoPlayerScreen17State extends State<VideoPlayerScreen17> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we study Trade, Commerce and Intercourse within the territory of India (Part XIII), examining the freedom of trade and its limitations.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part XIII consists of Articles 301 to 307. It establishes that trade and commerce throughout India shall be free, subject to parliamentary regulations in public interest.',
                      ...
                      Expanded(
                        flex: 4,
                        child: Column(children: [
                          _buildStatCard('Articles', '301 - 307', Icons.menu_book_rounded),
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Art 301, Inter-state Trade, Freedom', 
