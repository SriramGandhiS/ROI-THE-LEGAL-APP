...
class VideoPlayerScreenS4 extends StatefulWidget {
  const VideoPlayerScreenS4({super.key});

  @override
  _VideoPlayerScreenS4State createState() => _VideoPlayerScreenS4State();
}

class _VideoPlayerScreenS4State extends State<VideoPlayerScreenS4> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we cover the 4th Schedule, which deals with the allocation of seats in the Rajya Sabha to the States and Union Territories.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'The Fourth Schedule specifies how many seats in the Upper House (Rajya Sabha) are assigned to each State and Union Territory.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Rajya Sabha, Seats, Allocation', 
