...
class VideoPlayerScreenS10 extends StatefulWidget {
  const VideoPlayerScreenS10({super.key});

  @override
  _VideoPlayerScreenS10State createState() => _VideoPlayerScreenS10State();
}

class _VideoPlayerScreenS10State extends State<VideoPlayerScreenS10> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we study the 10th Schedule, popularly known as the Anti-Defection Law, which specifies provisions as to disqualification on ground of defection.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'The Tenth Schedule was added to discourage political defections by providing for disqualification of members of Parliament and State Legislatures.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Anti-Defection, Disqualification, Political Stability', 
