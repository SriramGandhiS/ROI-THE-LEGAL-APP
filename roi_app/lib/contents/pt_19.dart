...
class VideoPlayerScreen19 extends StatefulWidget {
  const VideoPlayerScreen19({super.key});

  @override
  _VideoPlayerScreen19State createState() => _VideoPlayerScreen19State();
}

class _VideoPlayerScreen19State extends State<VideoPlayerScreen19> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we study Tribunals (Part XIVA), focusing on specialized quasi-judicial bodies for administrative and other matters.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part XIVA (Articles 323A-323B) provides for administrative tribunals and tribunals for other matters, added by the 42nd Amendment Act.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('CAT, SAT, Quasi-judicial', 
