...
class VideoPlayerScreen9A extends StatefulWidget {
  const VideoPlayerScreen9A({super.key});

  @override
  _VideoPlayerScreen9AState createState() => _VideoPlayerScreen9AState();
}

class _VideoPlayerScreen9AState extends State<VideoPlayerScreen9A> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we cover additional provisions and appendices relating to the State Governments and their administrative functions.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'This lesson provides detailed insights into the specific powers and duties of state-level institutions as defined in the Constitutional Appendices.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('State List, Executive Powers', 
