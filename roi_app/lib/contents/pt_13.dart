...
class VideoPlayerScreen13 extends StatefulWidget {
  const VideoPlayerScreen13({super.key});

  @override
  _VideoPlayerScreen13State createState() => _VideoPlayerScreen13State();
}

class _VideoPlayerScreen13State extends State<VideoPlayerScreen13> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we study The Municipalities (Part IXA) and The Co-operative Societies (Part IXB), covering urban local bodies and collective enterprises.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part IXA (Articles 243P-243ZG) and Part IXB (Articles 243ZH-243ZT) regulate urban governance and the democratic control of co-operative societies.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Nagar Palika, Ward Committee, Co-op', 
