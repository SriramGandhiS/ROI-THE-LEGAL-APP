...
class VideoPlayerScreenS6 extends StatefulWidget {
  const VideoPlayerScreenS6({super.key});

  @override
  _VideoPlayerScreenS6State createState() => _VideoPlayerScreenS6State();
}

class _VideoPlayerScreenS6State extends State<VideoPlayerScreenS6> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we study the 6th Schedule, which contains provisions for the administration of Tribal Areas in the States of Assam, Meghalaya, Tripura, and Mizoram.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'The Sixth Schedule deals with the administration of Tribal Areas in four North-Eastern States, providing for Autonomous District Councils.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Autonomous Councils, North-East, Tribal Rights', 
