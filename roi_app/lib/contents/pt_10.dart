...
class VideoPlayerScreen10 extends StatefulWidget {
  const VideoPlayerScreen10({super.key});

  @override
  _VideoPlayerScreen10State createState() => _VideoPlayerScreen10State();
}

class _VideoPlayerScreen10State extends State<VideoPlayerScreen10> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we study The State Legislature (Part VI, Chapter III), which is the legislative body in the states of India.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part VI, Chapter III consists of Articles 168 to 212. It covers the composition of Legislative Assemblies and Councils, and their legislative functions.',
                      ...
                      Expanded(
                        flex: 4,
                        child: Column(children: [
                          _buildStatCard('Articles', '168 - 212', Icons.menu_book_rounded),
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('MLA, MLC, Assembly, Council', 
