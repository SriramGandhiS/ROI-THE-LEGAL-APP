...
class VideoPlayerScreen22 extends StatefulWidget {
  const VideoPlayerScreen22({super.key});

  @override
  _VideoPlayerScreen22State createState() => _VideoPlayerScreen22State();
}

class _VideoPlayerScreen22State extends State<VideoPlayerScreen22> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we cover Official Language (Part XVII), including the language of the Union, regional languages, and the language of the judiciary.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part XVII (Articles 343-351) deals with the official languages of the Union, regional languages, and special directives for the development of Hindi.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Hindi, English, 8th Schedule', 
