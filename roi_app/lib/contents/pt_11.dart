...
class VideoPlayerScreen11 extends StatefulWidget {
  const VideoPlayerScreen11({super.key});

  @override
  _VideoPlayerScreen11State createState() => _VideoPlayerScreen11State();
}

class _VideoPlayerScreen11State extends State<VideoPlayerScreen11> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we explore The High Courts and Subordinate Courts (Part VI), detailing the judicial structure within the states.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part VI, Chapters V and VI consist of Articles 214 to 237. It establishes High Courts as the highest judicial authority in states and subordinates district courts to them.',
                      ...
                      Expanded(
                        flex: 4,
                        child: Column(children: [
                          _buildStatCard('Articles', '214 - 237', Icons.menu_book_rounded),
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('High Court, District Court, Judiciary', 
