...
class _VideoPlayerScreen2State extends State<VideoPlayerScreen2> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we continue our exploration of the Indian Constitution, focusing on Citizenship and related provisions in Part II.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Articles 5 to 11 of Part II deal with Citizenship status at the time of the Constitution.',
                      ...
                      // Right Side: Secondary Info (split)
                      Expanded(
                        flex: 4,
                        child: Column(children: [
                          _buildStatCard('Articles', '5 - 11', Icons.menu_book_rounded),
                          const SizedBox(height: 12),
                          _buildStatCard('Level', 'Medium', Icons.auto_awesome_rounded),
                        ]),
                      ),
                    ]),
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Citizens, NRIs, Overseas Citizens, Naturalization.', 
