...
class VideoPlayerScreenS8 extends StatefulWidget {
  const VideoPlayerScreenS8({super.key});

  @override
  _VideoPlayerScreenS8State createState() => _VideoPlayerScreenS8State();
}

class _VideoPlayerScreenS8State extends State<VideoPlayerScreenS8> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we study the 8th Schedule, which lists the recognized languages of the Republic of India.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'The Eighth Schedule originally contained 14 languages, but now includes 22 officially recognized regional languages of India.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Official Languages, Regional Varieties', 
