...
class VideoPlayerScreen14 extends StatefulWidget {
  const VideoPlayerScreen14({super.key});

  @override
  _VideoPlayerScreen14State createState() => _VideoPlayerScreen14State();
}

class _VideoPlayerScreen14State extends State<VideoPlayerScreen14> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we examine The Scheduled and Tribal Areas (Part X), focusing on the special administration of specifically designated regions.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part X (Articles 244-244A) provides for the administration of areas inhabited by specific backward classes and tribal communities in various states.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('5th Schedule, 6th Schedule, Tribal Council', 
