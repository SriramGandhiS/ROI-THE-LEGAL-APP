...
class VideoPlayerScreen20 extends StatefulWidget {
  const VideoPlayerScreen20({super.key});

  @override
  _VideoPlayerScreen20State createState() => _VideoPlayerScreen20State();
}

class _VideoPlayerScreen20State extends State<VideoPlayerScreen20> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we cover Elections (Part XV), focusing on the Election Commission and adult suffrage.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part XV (Articles 324-329) mandates free and fair elections, establishing the Election Commission of India and Universal Adult Franchise.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('EC, Art 324, Voting Age', 
