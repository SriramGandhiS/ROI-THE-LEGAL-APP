...
class VideoPlayerScreen16 extends StatefulWidget {
  const VideoPlayerScreen16({super.key});

  @override
  _VideoPlayerScreen16State createState() => _VideoPlayerScreen16State();
}

class _VideoPlayerScreen16State extends State<VideoPlayerScreen16> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we cover Finance, Property, Contracts and Suits (Part XII), including the distribution of revenues and the Right to Property.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part XII consists of Articles 264 to 300A. It covers the consolidated fund, contingency fund, Finance Commission, and Article 300A (Right to Property).',
                      ...
                      Expanded(
                        flex: 4,
                        child: Column(children: [
                          _buildStatCard('Articles', '264 - 300', Icons.menu_book_rounded),
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Revenue, GST, Property Rights', 
