...
class VideoPlayerScreen18 extends StatefulWidget {
  const VideoPlayerScreen18({super.key});

  @override
  _VideoPlayerScreen18State createState() => _VideoPlayerScreen18State();
}

class _VideoPlayerScreen18State extends State<VideoPlayerScreen18> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we cover Services under the Union and the States (Part XIV), including the Public Service Commissions.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part XIV (Articles 308-323) creates the framework for public services, including the recruitment and conditions of service of persons serving the Union or States.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('UPSC, State PSC, Civil Services', 
