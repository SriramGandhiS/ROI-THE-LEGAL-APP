...
class VideoPlayerScreen12 extends StatefulWidget {
  const VideoPlayerScreen12({super.key});

  @override
  _VideoPlayerScreen12State createState() => _VideoPlayerScreen12State();
}

class _VideoPlayerScreen12State extends State<VideoPlayerScreen12> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we cover Union Territories (Part VIII) and The Panchayats (Part IX), focusing on local self-governance in rural India.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part VIII (Articles 239-242) and Part IX (Articles 243-243O) establish the administration of Union Territories and the three-tier Panchayati Raj system.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('UT, Panchayat, Gram Sabha', 
