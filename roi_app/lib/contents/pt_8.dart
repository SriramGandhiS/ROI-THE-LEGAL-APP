...
class VideoPlayerScreen8 extends StatefulWidget {
  const VideoPlayerScreen8({super.key});

  @override
  _VideoPlayerScreen8State createState() => _VideoPlayerScreen8State();
}

class _VideoPlayerScreen8State extends State<VideoPlayerScreen8> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we examine The Union Judiciary (Part V, Chapter IV), detailing the powers and jurisdiction of the Supreme Court of India.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part V, Chapter IV consists of Articles 124 to 147. It establishes the Supreme Court and defines its jurisdiction as the final interpreter of the Constitution.',
                      ...
                      Expanded(
                        flex: 4,
                        child: Column(children: [
                          _buildStatCard('Articles', '124 - 147', Icons.menu_book_rounded),
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Supreme Court, Jurisdiction, Judiciary', 
