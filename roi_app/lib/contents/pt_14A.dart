...
class VideoPlayerScreen14A extends StatefulWidget {
  const VideoPlayerScreen14A({super.key});

  @override
  _VideoPlayerScreen14AState createState() => _VideoPlayerScreen14AState();
}

class _VideoPlayerScreen14AState extends State<VideoPlayerScreen14A> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'This lesson explores specialized administrative structures for Tribal and Scheduled Areas within different States.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'This supplementary session covers specific administrative guidelines for designated Tribal Districts and Scheduled Areas.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('5th Schedule, 6th Schedule', 
