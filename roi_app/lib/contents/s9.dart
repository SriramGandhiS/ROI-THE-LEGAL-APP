...
class VideoPlayerScreenS9 extends StatefulWidget {
  const VideoPlayerScreenS9({super.key});

  @override
  _VideoPlayerScreenS9State createState() => _VideoPlayerScreenS9State();
}

class _VideoPlayerScreenS9State extends State<VideoPlayerScreenS9> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we cover the 9th Schedule, which was added to protect laws included in it from judicial review on the ground of violation of Fundamental Rights.',
                  ...
                  child: Column(children: [
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Land Reforms, Judicial Immunity', 
