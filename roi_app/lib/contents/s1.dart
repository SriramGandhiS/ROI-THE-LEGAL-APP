...
class VideoPlayerScreenS1 extends StatefulWidget {
  const VideoPlayerScreenS1({super.key});

  @override
  _VideoPlayerScreenS1State createState() => _VideoPlayerScreenS1State();
}

class _VideoPlayerScreenS1State extends State<VideoPlayerScreenS1> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we study the 1st Schedule of the Constitution, which lists the States and Union Territories of India.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Lists the Names of States and Union Territories and their territorial jurisdiction.',
                      ...
                      Expanded(
                        flex: 4,
                        child: Column(children: [
                          _buildStatCard('Type', 'Territory', Icons.map_rounded),
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('States, UTs, Boundaries, Territorial Jurisdiction.', 
