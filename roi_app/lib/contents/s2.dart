...
class VideoPlayerScreenS2 extends StatefulWidget {
  const VideoPlayerScreenS2({super.key});

  @override
  _VideoPlayerScreenS2State createState() => _VideoPlayerScreenS2State();
}

class _VideoPlayerScreenS2State extends State<VideoPlayerScreenS2> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we cover the 2nd Schedule, which specifies the emoluments, allowances, and privileges of high officials.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'The Second Schedule outlines the salaries and benefits for high constitutional authorities.',
                            style: TextStyle(fontFamily: 'Inter', fontSize: 14, color: AppColors.textPrimary, height: 1.5, fontWeight: FontWeight.w500),
                          ),
                          const SizedBox(height: 20),
                          _buildPremiumChip(Icons.timer_rounded, '10 Min'),
                        ]),
                      ),
                      ...
                      Expanded(
                        flex: 4,
                        child: Column(children: [
                          _buildStatCard('Topic', 'Salaries', Icons.payments_rounded),
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('President, Judges, Emoluments, Allowances, Privileges.', 
