...
class VideoPlayerScreenS11 extends StatefulWidget {
  const VideoPlayerScreenS11({super.key});

  @override
  _VideoPlayerScreenS11State createState() => _VideoPlayerScreenS11State();
}

class _VideoPlayerScreenS11State extends State<VideoPlayerScreenS11> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we study the 11th Schedule, which contains provisions that specify the powers, authority and responsibilities of Panchayats.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'The Eleventh Schedule specifies the powers, authority and responsibilities of Panchayats (Rural Local Government).',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Panchayats, Rural Governance, 73rd Amendment', 
