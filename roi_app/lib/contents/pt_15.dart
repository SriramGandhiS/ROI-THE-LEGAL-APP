...
class VideoPlayerScreen15 extends StatefulWidget {
  const VideoPlayerScreen15({super.key});

  @override
  _VideoPlayerScreen15State createState() => _VideoPlayerScreen15State();
}

class _VideoPlayerScreen15State extends State<VideoPlayerScreen15> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we study Relations between the Union and the States (Part XI), covering legislative and administrative distributions of power.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part XI consists of Articles 245 to 263. It defines how the Union and States share legislative authority and how administrative cooperation is maintained between them.',
                      ...
                      Expanded(
                        flex: 4,
                        child: Column(children: [
                          _buildStatCard('Articles', '245 - 263', Icons.menu_book_rounded),
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Lists, Distribution of Power, Art 245', 
