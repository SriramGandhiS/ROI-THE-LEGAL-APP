...
class VideoPlayerScreen5 extends StatefulWidget {
  const VideoPlayerScreen5({super.key});

  @override
  _VideoPlayerScreen5State createState() => _VideoPlayerScreen5State();
}

class _VideoPlayerScreen5State extends State<VideoPlayerScreen5> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we cover Fundamental Duties (Part IVA), which are the moral obligations of all citizens to help promote a spirit of patriotism and uphold the unity of India.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part IVA consists of Article 51A. It lists 11 fundamental duties that citizens are expected to perform to foster a sense of responsibility toward the nation.',
                      ...
                      Expanded(
                        flex: 4,
                        child: Column(children: [
                          _buildStatCard('Articles', 'Constitution', Icons.menu_book_rounded),
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Patriotism, Unity, Integrity', 
