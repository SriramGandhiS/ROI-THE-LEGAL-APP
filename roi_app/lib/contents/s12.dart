...
class VideoPlayerScreenS12 extends StatefulWidget {
  const VideoPlayerScreenS12({super.key});

  @override
  _VideoPlayerScreenS12State createState() => _VideoPlayerScreenS12State();
}

class _VideoPlayerScreenS12State extends State<VideoPlayerScreenS12> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we study the 12th Schedule, which contains provisions that specify the powers, authority and responsibilities of Municipalities.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'The Twelfth Schedule specifies the powers, authority and responsibilities of Municipalities (Urban Local Government).',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Municipalities, Urban Governance, 74th Amendment', 
