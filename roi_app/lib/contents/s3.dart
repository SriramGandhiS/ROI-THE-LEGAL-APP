...
class VideoPlayerScreenS3 extends StatefulWidget {
  const VideoPlayerScreenS3({super.key});

  @override
  _VideoPlayerScreenS3State createState() => _VideoPlayerScreenS3State();
}

class _VideoPlayerScreenS3State extends State<VideoPlayerScreenS3> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we study the 3rd Schedule, which contains the forms of Oaths or Affirmations for various offices.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'The Third Schedule details the exact wording for oaths taken by Ministers, MPs, Judges, and the CAG before they assume office.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Oaths, Affirmations, MPs, Judges', 
