...
class VideoPlayerScreenS7 extends StatefulWidget {
  const VideoPlayerScreenS7({super.key});

  @override
  _VideoPlayerScreenS7State createState() => _VideoPlayerScreenS7State();
}

class _VideoPlayerScreenS7State extends State<VideoPlayerScreenS7> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we study the 7th Schedule, which defines the division of powers between the Union and the States using three lists.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'The Seventh Schedule categorizes subjects into the Union List, State List, and Concurrent List to ensure clear law-making authority.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Union List, State List, Concurrent List', 
