...
class VideoPlayerScreen9 extends StatefulWidget {
  const VideoPlayerScreen9({super.key});

  @override
  _VideoPlayerScreen9State createState() => _VideoPlayerScreen9State();
}

class _VideoPlayerScreen9State extends State<VideoPlayerScreen9> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we cover The States (Part VI), focusing on the Executive branch within each state, led by the Governor.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part VI, Chapter II consists of Articles 153 to 167. It defines the role of the Governor and the Council of Ministers in the governance of states.',
                      ...
                      Expanded(
                        flex: 4,
                        child: Column(children: [
                          _buildStatCard('Articles', '153 - 167', Icons.menu_book_rounded),
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Governor, State Cabinet, Chief Minister', 
