...
class VideoPlayerScreen6 extends StatefulWidget {
  const VideoPlayerScreen6({super.key});

  @override
  _VideoPlayerScreen6State createState() => _VideoPlayerScreen6State();
}

class _VideoPlayerScreen6State extends State<VideoPlayerScreen6> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we begin exploring The Union (Part V), starting with the Executive branch, including the President, Vice-President, and Council of Ministers.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part V, Chapter I consists of Articles 52 to 78. It establishes the office of the President as the head of the Union and details the executive powers of the Union.',
                      ...
                      Expanded(
                        flex: 4,
                        child: Column(children: [
                          _buildStatCard('Articles', '52 - 78', Icons.menu_book_rounded),
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('President, Executive, Cabinet', 
