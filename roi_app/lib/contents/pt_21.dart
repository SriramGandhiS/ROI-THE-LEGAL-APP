...
class VideoPlayerScreen21 extends StatefulWidget {
  const VideoPlayerScreen21({super.key});

  @override
  _VideoPlayerScreen21State createState() => _VideoPlayerScreen21State();
}

class _VideoPlayerScreen21State extends State<VideoPlayerScreen21> with TickerProviderStateMixin {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'In this lesson, we study Special Provisions Relating to Certain Classes (Part XVI), covering reservations and representations.',
                  ...
                  child: Column(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const Text(
                            'Part XVI (Articles 330-342) provides special protection for Scheduled Castes, Scheduled Tribes, and other classes in legislatures and services.',
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 12),
                        const Text('Reservation, SC/ST, Commission', 
