...
class QuizScreenS2 extends StatefulWidget {
  const QuizScreenS2({super.key});

  @override
  State<QuizScreenS2> createState() => _QuizScreenS2State();
}

class _QuizScreenS2State extends State<QuizScreenS2> {
  ...
  void _showFeedbackDialog(bool isCorrect) {
    showDialog(
      ...
      builder: (context) => _gamifiedDialog(
        ...
        content: isCorrect ? "Magnificent! You're a scholar! 🚀" : "The correct answer is:\n${widget.questions[_currentIndex].correctAnswer}",
