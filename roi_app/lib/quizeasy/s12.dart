...
class QuizScreenS12 extends StatefulWidget {
  const QuizScreenS12({super.key});

  @override
  State<QuizScreenS12> createState() => _QuizScreenS12State();
}

class _QuizScreenS12State extends State<QuizScreenS12> {
  ...
  void _showFeedbackDialog(bool isCorrect) {
    showDialog(
      ...
      builder: (context) => _gamifiedDialog(
        ...
        content: isCorrect ? "Profound Knowledge! 🚀" : "The correct answer is:\n${widget.questions[_currentIndex].correctAnswer}",
