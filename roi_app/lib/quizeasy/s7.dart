...
class QuizScreenS7 extends StatefulWidget {
  const QuizScreenS7({super.key});

  @override
  State<QuizScreenS7> createState() => _QuizScreenS7State();
}

class _QuizScreenS7State extends State<QuizScreenS7> {
  ...
  void _showFeedbackDialog(bool isCorrect) {
    showDialog(
      ...
      builder: (context) => _gamifiedDialog(
        ...
        content: isCorrect ? "Stellar performance! 🚀" : "The correct answer is:\n${widget.questions[_currentIndex].correctAnswer}",
