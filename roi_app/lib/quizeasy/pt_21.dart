...
class QuizScreen21 extends StatefulWidget {
  const QuizScreen21({super.key});

  @override
  State<QuizScreen21> createState() => _QuizScreen21State();
}
...
class _QuizLogicWidgetState extends State<QuizLogicWidget> {
  ...
  void _showFeedbackDialog(bool isCorrect) {
    showDialog(
      ...
      builder: (context) => _gamifiedDialog(
        ...
        content: isCorrect ? "Phenomenal learning! 🚀" : "The correct answer is:\n${widget.questions[_currentIndex].correctAnswer}",
  ...
  Widget build(BuildContext context) {
    return ThemedQuizScreen(
      title: 'Part XXI: Temporary Provisions Quiz',
