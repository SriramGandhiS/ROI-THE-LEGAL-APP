...
class QuizScreenS8 extends StatefulWidget {
  const QuizScreenS8({super.key});

  @override
  State<QuizScreenS8> createState() => _QuizScreenS8State();
}

class _QuizScreenS8State extends State<QuizScreenS8> {
  ...
  void _showFeedbackDialog(bool isCorrect) {
    showDialog(
      ...
      builder: (context) => _gamifiedDialog(
        ...
        content: isCorrect ? "Magnificent Mastery! 🚀" : "The correct answer is:\n${widget.questions[_currentIndex].correctAnswer}",
