...
class QuizScreenS3 extends StatefulWidget {
  const QuizScreenS3({super.key});

  @override
  State<QuizScreenS3> createState() => _QuizScreenS3State();
}

class _QuizScreenS3State extends State<QuizScreenS3> {
  ...
  void _showFeedbackDialog(bool isCorrect) {
    showDialog(
      ...
      builder: (context) => _gamifiedDialog(
        ...
        content: isCorrect ? "Incredible knowledge! 🚀" : "The correct answer is:\n${widget.questions[_currentIndex].correctAnswer}",
