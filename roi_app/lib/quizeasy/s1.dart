...
class QuizScreenS1 extends StatefulWidget {
  const QuizScreenS1({super.key});

  @override
  State<QuizScreenS1> createState() => _QuizScreenS1State();
}

class _QuizScreenS1State extends State<QuizScreenS1> {
