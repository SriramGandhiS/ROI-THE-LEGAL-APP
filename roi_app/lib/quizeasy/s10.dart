...
class QuizScreenS10 extends StatefulWidget {
  const QuizScreenS10({super.key});

  @override
  State<QuizScreenS10> createState() => _QuizScreenS10State();
}

class _QuizScreenS10State extends State<QuizScreenS10> {
  ...
  void _showFeedbackDialog(bool isCorrect) {
    showDialog(
      ...
      builder: (context) => _gamifiedDialog(
        ...
        content: isCorrect ? "Simply Divine Mastery! 🚀" : "The correct answer is:\n${widget.questions[_currentIndex].correctAnswer}",
