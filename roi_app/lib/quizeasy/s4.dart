...
class QuizScreenS4 extends StatefulWidget {
  const QuizScreenS4({super.key});

  @override
  State<QuizScreenS4> createState() => _QuizScreenS4State();
}

class _QuizScreenS4State extends State<QuizScreenS4> {
  ...
  void _showFeedbackDialog(bool isCorrect) {
    showDialog(
      ...
      builder: (context) => _gamifiedDialog(
        ...
        content: isCorrect ? "Spectacular! You're a pro! 🚀" : "The correct answer is:\n${widget.questions[_currentIndex].correctAnswer}",
