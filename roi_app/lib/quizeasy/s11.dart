...
class QuizScreenS11 extends StatefulWidget {
  const QuizScreenS11({super.key});

  @override
  State<QuizScreenS11> createState() => _QuizScreenS11State();
}

class _QuizScreenS11State extends State<QuizScreenS11> {
  ...
  void _showFeedbackDialog(bool isCorrect) {
    showDialog(
      ...
      builder: (context) => _gamifiedDialog(
        ...
        content: isCorrect ? "Radiant Intelligence! 🚀" : "The correct answer is:\n${widget.questions[_currentIndex].correctAnswer}",
