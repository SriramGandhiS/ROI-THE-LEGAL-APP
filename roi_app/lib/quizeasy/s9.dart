...
class QuizScreenS9 extends StatefulWidget {
  const QuizScreenS9({super.key});

  @override
  State<QuizScreenS9> createState() => _QuizScreenS9State();
}

class _QuizScreenS9State extends State<QuizScreenS9> {
  ...
  void _showFeedbackDialog(bool isCorrect) {
    showDialog(
      ...
      builder: (context) => _gamifiedDialog(
        ...
        content: isCorrect ? "Radiant Learning! 🌟🚀" : "The correct answer is:\n${widget.questions[_currentIndex].correctAnswer}",
