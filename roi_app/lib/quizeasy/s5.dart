...
class QuizScreenS5 extends StatefulWidget {
  const QuizScreenS5({super.key});

  @override
  State<QuizScreenS5> createState() => _QuizScreenS5State();
}

class _QuizScreenS5State extends State<QuizScreenS5> {
  ...
  void _showFeedbackDialog(bool isCorrect) {
    showDialog(
      ...
      builder: (context) => _gamifiedDialog(
        ...
        content: isCorrect ? "Masterful! You're on fire! 🔥🚀" : "The correct answer is:\n${widget.questions[_currentIndex].correctAnswer}",
