...
class QuizScreen20 extends StatefulWidget {
  const QuizScreen20({super.key});

  @override
  State<QuizScreen20> createState() => _QuizScreen20State();
}
  ...
  void _showFeedbackDialog(bool isCorrect) {
    showDialog(
      ...
      builder: (context) => _gamifiedDialog(
        ...
        content: isCorrect ? "You're a rising star! 🚀" : "The correct answer is:\n${widget.questions[_currentIndex].correctAnswer}",
