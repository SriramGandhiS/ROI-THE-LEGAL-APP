...
class QuizScreenS6 extends StatefulWidget {
  const QuizScreenS6({super.key});

  @override
  State<QuizScreenS6> createState() => _QuizScreenS6State();
}

class _QuizScreenS6State extends State<QuizScreenS6> {
  ...
  void _showFeedbackDialog(bool isCorrect) {
    showDialog(
      ...
      builder: (context) => _gamifiedDialog(
        ...
        content: isCorrect ? "Exceptional work! 🚀" : "The correct answer is:\n${widget.questions[_currentIndex].correctAnswer}",
