...
class QuizScreen14Ah extends StatefulWidget {
  const QuizScreen14Ah({super.key});

  @override
  State<QuizScreen14Ah> createState() => _QuizScreen14AhState();
}

class _QuizScreen14AhState extends State<QuizScreen14Ah> {
  ...
  Future<List<QuizQuestionData>> _fetchQuestions() async {
    try {
      QuerySnapshot snapshot = await _firestore.collection('pt_14A').get();
