...
class QuizScreenS3h extends StatefulWidget {
  const QuizScreenS3h({super.key});

  @override
  State<QuizScreenS3h> createState() => _QuizScreenS3hState();
}

class _QuizScreenS3hState extends State<QuizScreenS3h> {
