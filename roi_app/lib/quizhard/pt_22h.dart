...
class QuizScreen22h extends StatefulWidget {
  const QuizScreen22h({super.key});

  @override
  State<QuizScreen22h> createState() => _QuizScreen22hState();
}

class _QuizScreen22hState extends State<QuizScreen22h> {
  ...
  Future<List<QuizQuestionData>> _fetchQuestions() async {
    try {
      QuerySnapshot snapshot = await _firestore.collection('pt_22h').get();
