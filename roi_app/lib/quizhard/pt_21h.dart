...
class QuizScreen21h extends StatefulWidget {
  const QuizScreen21h({super.key});

  @override
  State<QuizScreen21h> createState() => _QuizScreen21hState();
}

class _QuizScreen21hState extends State<QuizScreen21h> {
  ...
  Future<List<QuizQuestionData>> _fetchQuestions() async {
    try {
      QuerySnapshot snapshot = await _firestore.collection('pt_21h').get();
