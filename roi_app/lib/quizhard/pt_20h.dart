...
class QuizScreen20h extends StatefulWidget {
  const QuizScreen20h({super.key});

  @override
  State<QuizScreen20h> createState() => _QuizScreen20hState();
}

class _QuizScreen20hState extends State<QuizScreen20h> {
  ...
  Future<List<QuizQuestionData>> _fetchQuestions() async {
    try {
      QuerySnapshot snapshot = await _firestore.collection('pt_20h').get();
