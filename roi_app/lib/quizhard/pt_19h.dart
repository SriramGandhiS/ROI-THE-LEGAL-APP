...
class QuizScreen19h extends StatefulWidget {
  const QuizScreen19h({super.key});

  @override
  State<QuizScreen19h> createState() => _QuizScreen19hState();
}

class _QuizScreen19hState extends State<QuizScreen19h> {
  ...
  Future<List<QuizQuestionData>> _fetchQuestions() async {
    try {
      QuerySnapshot snapshot = await _firestore.collection('pt_19h').get();
