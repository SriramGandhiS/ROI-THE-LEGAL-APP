...
class QuizScreen17h extends StatefulWidget {
  const QuizScreen17h({super.key});

  @override
  State<QuizScreen17h> createState() => _QuizScreen17hState();
}

class _QuizScreen17hState extends State<QuizScreen17h> {
  ...
  Future<List<QuizQuestionData>> _fetchQuestions() async {
    try {
      QuerySnapshot snapshot = await _firestore.collection('pt_17h').get();
