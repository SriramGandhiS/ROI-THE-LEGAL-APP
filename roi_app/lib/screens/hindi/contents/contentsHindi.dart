...
class _ContentsState extends State<Contentshindi> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/part1': (context) => const VideoPlayerScreen1hindi(),
        '/part2': (context) => const VideoPlayerScreen2hindi(),
        '/part3': (context) => const VideoPlayerScreen3(),
        '/part4': (context) => const VideoPlayerScreen4(),
        '/part4A': (context) => const VideoPlayerScreen4A(),
        '/part5': (context) => const VideoPlayerScreen5(),
        '/part6': (context) => const VideoPlayerScreen6(),
        '/part7': (context) => const VideoPlayerScreen7(),
        '/part8': (context) => const VideoPlayerScreen8(),
        '/part9': (context) => const VideoPlayerScreen9(),
        '/part10': (context) => const VideoPlayerScreen10(),
        '/part11': (context) => const VideoPlayerScreen11(),
        '/part12': (context) => const VideoPlayerScreen12(),
        '/part13': (context) => const VideoPlayerScreen13(),
        '/part14': (context) => const VideoPlayerScreen14(),
        '/part14A': (context) => const VideoPlayerScreen14A(),
        '/part15': (context) => const VideoPlayerScreen15(),
        '/part16': (context) => const VideoPlayerScreen16(),
        '/part17': (context) => const VideoPlayerScreen17(),
        '/part18': (context) => const VideoPlayerScreen18(),
        '/part19': (context) => const VideoPlayerScreen19(),
        '/part20': (context) => const VideoPlayerScreen20(),
        '/part21': (context) => const VideoPlayerScreen21(),
        '/part22': (context) => const VideoPlayerScreen22(),
        '/schedule1': (context) => const VideoPlayerScreenS1(),
        '/schedule2': (context) => const VideoPlayerScreenS2(),
        '/schedule3': (context) => const VideoPlayerScreenS3(),
        '/schedule4': (context) => const VideoPlayerScreenS4(),
        '/schedule5': (context) => const VideoPlayerScreenS5(),
        '/schedule6': (context) => const VideoPlayerScreenS6(),
        '/schedule7': (context) => const VideoPlayerScreenS7(),
        '/schedule8': (context) => const VideoPlayerScreenS8(),
        '/schedule9': (context) => const VideoPlayerScreenS9(),
        '/schedule10': (context) => const VideoPlayerScreenS10(),
        '/schedule11': (context) => const VideoPlayerScreenS11(),
        '/schedule12': (context) => const VideoPlayerScreenS12(),
      },
      home: Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (context) => const Dashpagehindi()),
              );
            },
          ),
        ),
